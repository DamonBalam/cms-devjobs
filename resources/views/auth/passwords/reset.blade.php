                ...
                <div class="flex flex-col break-words bg-white border shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('password.update') }}" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-200 rounded w-full @error('email') border border-red-500 @enderror"
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password"
                                class="p-3 bg-gray-200 rounded w-full @error('password') border border-red-500 @enderror" name="password"
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password-confirm" type="password" class="p-3 bg-gray-200 rounded w-full" name="password_confirmation"
                                 autocomplete="new-password">
