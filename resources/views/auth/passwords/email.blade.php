            ...
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border shadow-md mt-20">
                    ...
                    <form class="py-10 px-5" method="POST" action="{{ route('password.email') }}" novalidate>
                        ...
                        @if (session('status'))
                            <span class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 w-full my-2 text-sm block"
                                role="alert">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email"
                                class="p-3 bg-gray-200 rounded w-full @error('email') border border-red-500 @enderror"
