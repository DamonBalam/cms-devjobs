                        ...
                        <form class="py-10 px-5" method="POST" action="{{ route('register') }}" novalidate>
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="name" type="text"
                                    class="p-3 bg-gray-200 rounded w-full @error('name') border border-red-500 @enderror" name="name"
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="email" type="email"
                                    class="p-3 bg-gray-200 rounded w-full @error('email') border border-red-500 @enderror" name="email"
                            ...
                            <div class="flex flex-wrap mb-6">
                                ...
                                <input id="password" type="password"
                                    class="p-3 bg-gray-200 rounded w-full @error('password') border border-red-500 @enderror"
