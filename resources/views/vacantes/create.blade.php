...
@section('content')
    ...
    <form class="max-w-lg mx-auto my-10" action="">
        <div class="mb-5">
            <label for="email" class="block text-gray-700 text-sm mb-2">Titulo Vacante:</label>

            <input id="titulo" type="text"
                class="p-3 bg-white rounded w-full @error('titulo') border border-red-500 @enderror" name="titulo"
                value="{{ old('titulo') }}">
        ...
        <button type="submit"
            class="bg-teal-500 w-full hover:bg-teal-600 text-gray-100 font-bold p-3 focus:outline-none focus:shadow-outline uppercase">Publicar
            Vacante
        </button>
    </form>
@endsection
...
@section('scripts')
    <script src="https://cdnjs.cloudflare.com/ajax/libs/medium-editor/5.23.3/js/medium-editor.min.js"
        integrity="sha512-5D/0tAVbq1D3ZAzbxOnvpLt7Jl/n8m/YGASscHTNYsBvTcJnrYNiDIJm6We0RPJCpFJWowOPNz9ZJx7Ei+yFiA==" defer
